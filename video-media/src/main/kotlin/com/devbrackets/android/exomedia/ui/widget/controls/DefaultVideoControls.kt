...
abstract class DefaultVideoControls : RelativeLayout, VideoControls {
    ...
    protected lateinit var backArrow: ImageButton
    protected lateinit var leftAreaButton: ImageButton
    protected lateinit var rightAreaButton: ImageButton
    ...
    protected open fun registerListeners() {
        ...
        leftAreaButton.setOnClickListener { leftAreaDoubleClick() }
        rightAreaButton.setOnClickListener { rightAreaDoubleClick() }
    }
    ...
    protected fun onBackArrowClick() {
        if (buttonsListener?.onBackArrowClicked() != true) {
            internalListener.onBackArrowClicked()
        }
    }

    protected fun leftAreaDoubleClick() {
        if (buttonsListener?.onLeftAreaDoubleClick() != true) {
            internalListener.onLeftAreaDoubleClick()
        }
    }

    protected fun rightAreaDoubleClick() {
        if (buttonsListener?.onRightAreaDoubleClick() != true) {
            internalListener.onRightAreaDoubleClick()
        }
    }
    ...
    protected open fun retrieveViews() {
        ...
        backArrow = findViewById(R.id.backPressView)
        leftAreaButton = findViewById(R.id.leftAreaButton)
        rightAreaButton = findViewById(R.id.rigthAreaButton)
    }
